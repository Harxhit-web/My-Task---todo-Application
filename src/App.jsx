  ...
  return (
    ...
    <Navbar/>
      <div className="mx-3 md:container md:mx-auto my-5 rounded-xl p-5 bg-violet-100 min-h-[80vh] md:w-1/2">
        <h1 className='font-bold text-center text-4xl'>MyTask - Manage your todos at one place</h1>
          <div className="addTodo my-5 flex flex-col gap-4">
            <h2 className='text-2xl font-bold flex gap-2 items-center'>Add a Todo  <FaPencilAlt className='text-xl'/></h2>
          ...
          <div className='h-[1px] bg-black opacity-15 w-[85%] mx-auto my-2'></div>
